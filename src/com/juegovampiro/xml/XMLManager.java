...
public class XMLManager {
    ...
    public static void loadCharacters(String path) throws Exception {
        ...
        for (int i = 0; i < nodes.getLength(); i++) {
            ...
            String nombre = e.getElementsByTagName("nombre").item(0).getTextContent();
            int salud     = Integer.parseInt(
                    e.getElementsByTagName("salud").item(0).getTextContent());
            int poder     = Integer.parseInt(
                    e.getElementsByTagName("poder").item(0).getTextContent());
            int oro       = Integer.parseInt(
                    e.getElementsByTagName("oro").item(0).getTextContent());
            ...
            switch (tipo.toLowerCase()) {
                case "vampiro" -> {
                    ...
                    int sangre = Integer.parseInt(
                            e.getElementsByTagName("sangre").item(0).getTextContent());
                ...
                case "licantropo" -> {
                    ...
                    int rabia = Integer.parseInt(
                            e.getElementsByTagName("rabia").item(0).getTextContent());
                    l.setRabia(rabia);
                    p = l;
                }
                case "cazador" -> {
                    ...
                    int vol = Integer.parseInt(
                            e.getElementsByTagName("voluntad").item(0).getTextContent());
                    c.setVoluntad(vol);
                    p = c;
                }
            }
    ...
    public static void saveCharacters(String path) throws Exception {
        ...
        for (Usuario u : usuarios) {
            for (Personaje p : u.getPersonajes()) {
                ...
                if      (p instanceof Vampiro)     pe.setAttribute("tipo", "vampiro");
                else if (p instanceof Licantropo)  pe.setAttribute("tipo", "licantropo");
                else if (p instanceof Cazador)     pe.setAttribute("tipo", "cazador");
    ...
    public static void loadCombates(String path) throws Exception {
        ...
        for (int i = 0; i < nodes.getLength(); i++) {
            ...
            int apuesta    = Integer.parseInt(
                    e.getElementsByTagName("apuesta").item(0).getTextContent());
            ...
            for (int j = 0; j < rList.getLength(); j++) {
                ...
                int dr   = Integer.parseInt(
                        re.getElementsByTagName("danioRetador").item(0).getTextContent());
                int dd   = Integer.parseInt(
                        re.getElementsByTagName("danioDesafiado").item(0).getTextContent());
